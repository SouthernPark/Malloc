...
int main(int argc, char * argv[]) {
  ...
  node_t * n1 = (node_t *)((char *)array[0] - NODE_SIZE);
  ...
  node_t * n2 = (node_t *)((char *)array[1] - NODE_SIZE);
  ...
  node_t * n3 = (node_t *)((char *)array[2] - NODE_SIZE);
  for (i = 0; i < size; i++) {
    array[2][i] = size;
  }  //for i
  for (i = 0; i < size; i++) {
  ...
  node_t * n4 = (node_t *)((char *)array[3] - NODE_SIZE);
  for (i = 0; i < size; i++) {
    array[3][i] = size;
  }  //for i
  for (i = 0; i < size; i++) {
